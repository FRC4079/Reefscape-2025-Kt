...
object Elevator : SubsystemBase() {
    private val elevatorMotorLeft: TalonFX
    private val elevatorMotorRight: TalonFX
     ...
     */
    init {
        elevatorMotorLeft = TalonFX(ELEVATOR_MOTOR_LEFT_ID)
        elevatorMotorRight = TalonFX(ELEVATOR_MOTOR_RIGHT_ID)
